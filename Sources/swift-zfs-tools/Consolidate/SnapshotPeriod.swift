...
extension ZFSTools.Consolidator.SnapshotPeriod.SnapshotFrequency {
  public class Builder: @unchecked Sendable {
    private var frequency = ZFSTools.Consolidator.SnapshotPeriod.SnapshotFrequency()

    public func build() -> ZFSTools.Consolidator.SnapshotPeriod.SnapshotFrequency {
    ...
    public func with(
      ...
      var snapshotComponents = [ZFSTools.Consolidator.SnapshotPeriod.SnapshotFrequencyComponent]()
      if let years = years {
...
extension ZFSTools.Consolidator.SnapshotPeriod.SnapshotFrequencyComponent: Equatable {
